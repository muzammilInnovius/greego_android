...
public class VehicleDetailAdapter extends RecyclerView.Adapter<VehicleDetailAdapter.TripHistoryViewHolder> {
    ...
    private List<VehicleDetailModel> VehicleModelList;
    RecyclerViewItemClickListener mListener;
    Context context;

    public VehicleDetailAdapter(Context context, List<VehicleDetailModel> users, RecyclerViewItemClickListener mListener) {
